...
class DoublebranchFeatureExtractionBlock(nn.Module):
    ...
    def __init__(self, dim, img_resolution, depth, num_heads, window_size,
        ...
        if resi_connection == '1conv':
            ...
            # self.conv = nn.Sequential(nn.Conv2d(dim*2, dim, 3, 1, 1),
            #                           nn.ReLU(True),
...
#                    embed_dim=180, num_heads=[6, 6, 6, 6, 6, 6], mlp_ratio=2, upsampler='')
#
