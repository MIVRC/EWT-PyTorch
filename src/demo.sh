...
python main.py --model EWT --scale 1 --patch_size 64 --save nh --reset
python main.py --model MWT --scale 1 --patch_size 64 --save snow_new --reset
's/(\d{4})_hazy\.png/$1_GT.png/' *.png
...
#python main.py --data_test DIV2K --data_range 72136-72635 --scale 1 --pre_train /home/Juncheng/EWT/experiment/uformer_ots/model/model_best.pt --test_only --save_results --reset
python main.py --data_test DIV2K --data_range 1-16801 --scale 1 --pre_train /mnt/sdc/org/home/bdc/EWT/experiment/snow_new/model/model_best.pt --test_only --save_results --ext sep_reset
